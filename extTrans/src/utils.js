...
// Uses IIFE pattern to expose functions via window.utils namespace for MV3 compatibility.
 ...
 */
  ...
  // Expose functions via window.utils namespace for MV3 content script compatibility
  if (typeof window !== 'undefined') {
    window.utils = {
      detectElementType: detectElementType,
