...
// Use utility functions from window.utils namespace (loaded via utils.js IIFE pattern)
const { convertValue, detectElementType } = window.utils;
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  ...
  console.log('content.js – request type:', request.type);
  ...
  switch (type) {
    ...
    case 'writeElement':
      ...
      break;
    default:
      console.warn('content.js – unknown action', type);
      response = null;
  }
  // Respond asynchronously if needed.
  console.log('content.js – sending response:', { result: response });
